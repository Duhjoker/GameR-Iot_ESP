...
#define BTN_DOWN_PIN    25 //corect
#define BTN_LEFT_PIN    27 // 
#define BTN_A_PIN       19 // A button
#define BTN_B_PIN       38 // B button
#define BTN_X_PIN       39 // X button
#define BTN_Y_PIN       20 // Y button
#define BTN_L_PIN       30 // Left shoulder
#define BTN_R_PIN       35 // right shoulder
#define BTN_S_PIN        1 // start
#define BTN_T_PIN       21 // select
